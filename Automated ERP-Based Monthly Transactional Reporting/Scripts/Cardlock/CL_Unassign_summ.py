...
output_file = r"C:\Users\CCE\Documents\Cool Creek Docs\Reports\Melinda\Raw\CL\Summary\CL_Unassign_summ.csv"
...
if data_frames:
    ...
    # Group and sum VOLUME (renamed from QTY) and AMOUNT based on required columns
