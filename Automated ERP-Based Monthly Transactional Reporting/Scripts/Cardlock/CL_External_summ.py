...
output_file = r"C:\Users\CCE\Documents\Cool Creek Docs\Reports\Melinda\Raw\CL\Summary\CL_External_summ.csv"
...
for file_name in excel_files:
    ...
    try:
        ...
        df = pd.read_excel(file_path, usecols=["QTY", "AMOUNT", "CCLSITE", "Database", "MOD", "Assigned/Unassigned", "YearMon", "Clear/Dyed"])
