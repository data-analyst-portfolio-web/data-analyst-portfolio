...
merged_output_file_base = r"C:\Users\CCE\Documents\Cool Creek Docs\Reports\Melinda\Raw\CL\Merged_Unassigned"
...
unassigned_files = [file for file in os.listdir(folder_path) if file.lower().startswith("unassigned") and file.lower().endswith('.xlsx')]

# Check if there are no matching files
if not unassigned_files:
    print("No 'Unassigned' files found in the folder.")
    sys.exit()  # Exit the program
else:
    # Process each "Unassigned" file
    for file_name in os.listdir(folder_path):
        if file_name.lower().startswith("unassigned") and file_name.lower().endswith('.xlsx'):
            ...
            df["Assigned/Unassigned"] = "Unassigned"
